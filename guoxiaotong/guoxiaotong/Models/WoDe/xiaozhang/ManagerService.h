...
/**设置班主任（classId，tutorId（班主任id,=teacherId）beginTime，endTime）*/
- (void)setBZR:(NSDictionary *)params callBack:(void (^)(BOOL isSuccess))callBack;

/**修改班级*/
- (void)editClass:(NSDictionary *)params callBack:(void (^)(BOOL isSuccess))callBack;
