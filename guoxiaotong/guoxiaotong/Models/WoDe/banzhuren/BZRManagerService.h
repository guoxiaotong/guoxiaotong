...
/**班主任管理：添加监护人*/
- (void)addJianhuren:(NSDictionary *)params callBack:(void (^)(BOOL isSuccess))callBack;
...
/**设置课程老师（teacherid，classId，userId，courseid）*/
- (void)setTeacher:(NSDictionary *)params callBack:(void (^)(BOOL isSuccess))callBack;

- (void)addStudent:(NSDictionary *)params callBack:(void (^)(BOOL isSuccess))callBack;
